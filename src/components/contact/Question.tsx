                    ...
                    <Container py={{ base: '60px', lg: '120px'}} maxW='1280px'>
                        <Box maxW='760px' mx='auto' textAlign='center' mb='56px' position='relative'>
                            ...
                            <chakra.h1
                                ...
                                lineHeight='1.2'
                            >
                                Stel ons je <span style={{color: "#801AFB"}}>vraag</span>.
                            </chakra.h1>
                            ...
                            <Text
                                ...
                                mt='6'
                            >
                                Wij beantwoorden het binnen de 24 uur.
                            </Text>
                            ...
                            <VStack spacing={4} mt={10} as="form" onSubmit={handleSubmit}>
                                ...
                                <FormControl isRequired mb={2}>
                                    ...
                                    <Textarea size={{ base: 'md', lg: 'lg'}} placeholder="stel je vraag" _focus={{ borderColor: '#801AFB', boxShadow: '0 0 0 1px #00044F' }} value={formData.question} onChange={handleChange} name="question" />
                                </FormControl>
                                <FormControl isRequired>
                                ...
                                <br/>
                                <FormControl>
                                    <FormLabel >Neem zeker ook eens een kijkje op onze <u>FAQ</u>, hier vind je een overzicht van onze meest gestelde vragen.</FormLabel>
                                </FormControl>
                                <br/><br/>
                                <Button
