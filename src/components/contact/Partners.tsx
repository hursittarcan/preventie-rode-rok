                    ...
                    <Container py={{ base: '60px', lg: '120px'}} maxW='1280px'>
                        <Box maxW='760px' mx='auto' textAlign='center' mb='56px' position='relative'>
                            ...
                            <chakra.h1
                                ...
                                lineHeight='1.2'
                            >
                                <span style={{color: "#801AFB"}}>Partner</span> in crime worden?
                            </chakra.h1>
                            ...
                            <Text
                                ...
                                mt='6'
                            >
                                Laat ons weten hoe we iets kunnen betekenen voor elkaar.
                            </Text>
                            ...
                            <VStack spacing={4} mt={10} as="form" onSubmit={handleSubmit}>
                                ...
                                <FormControl mb={2} isRequired>
                                    <FormLabel fontWeight="semibold">Hoe kunnen we elkaar ondersteunen?</FormLabel>
                                    <Textarea size={{ base: 'md', lg: 'lg'}} placeholder="..." _focus={{ borderColor: '#801AFB', boxShadow: '0 0 0 1px #00044F' }} value={formData.question} onChange={handleChange} name="question" />
                                </FormControl>
                                <br/><br/>
                                <Button
